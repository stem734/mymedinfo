...
const AdminDashboard: React.FC = () => {
  ...
  // ⚡ Bolt: Memoize expensive dashboard statistics to avoid O(N) calculations on every render.
  ...
  // ⚡ Bolt: Memoize the filtered practices list using a deferred search value.
  // This prevents expensive string matching and filtering on every keystroke,
  // keeping the search input responsive while the list updates asynchronously.
  const filteredPractices = useMemo(
    ...
    [practices, deferredPracticeSearch, practiceStatusFilter],
  );
