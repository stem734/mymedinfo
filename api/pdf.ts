...
export default {
  async fetch(request: Request): Promise<Response> {
    try {
      ...
      // Block protocol-relative paths (//) and backslash-prefixed paths (/\) which can bypass startsWith("/")
      ...
      // Ensure the resolved target URL is on the same origin as the request
