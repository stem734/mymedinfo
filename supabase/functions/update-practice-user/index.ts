...
serve(async (req) => {
  ...
  try {
    ...
    const targetIsGpRatifier = targetPracticeUser.is_gp_ratifier === true;
    const isGpRatifier = body.isGpRatifier === false ? false : body.isGpRatifier === true ? true : targetIsGpRatifier;
    const isChangingGpRatifier = body.isGpRatifier !== undefined && body.isGpRatifier !== targetIsGpRatifier;
